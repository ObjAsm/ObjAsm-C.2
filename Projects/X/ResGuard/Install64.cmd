...
rem copy ResGuard64.dll "%OBJASM_PATH%\Projects\X\ResGuard\LeakTest1\ResGuard64.dll"
copy ResGuard64.dll "%OBJASM_PATH%\Projects\Private\TestRoomObserver V4\ResGuard64.dll"
