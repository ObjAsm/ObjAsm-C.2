...
include FireworksApp_Main.inc                           ;Include FireworksApp object

start proc                                              ;Program entry point
  SysInit                                               ;Runtime initialization of OOP model

  OCall $ObjTmpl(FireworksApp)::FireworksApp.Init       ;Initialize the object data
  OCall $ObjTmpl(FireworksApp)::FireworksApp.Run        ;Execute the application
  OCall $ObjTmpl(FireworksApp)::FireworksApp.Done       ;Finalize it
