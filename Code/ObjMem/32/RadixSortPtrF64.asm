...
.code
align ALIGN_CODE
RadixSortPtrF64 proc pArray:POINTER, dCount:DWORD, dOffset:DWORD, pWorkArea:POINTER
  push ebx
  ...
  .else
    ...
    .if eax != NULL
      ...
      RadixPassPtr 4, edi, esi
      RadixPassPtr 5, esi, edi
      RadixPassPtr 6, edi, esi

      ;Modified RadixPassPtr 7                        :MSB
      ResetRadixCounters
      CountRadixPtr 7, edi
      GetRadixCountToIndexNegFirst TRUE
      SortRadixPtr 7, esi, edi, TRUE                  ;Reverse order of negative floats
