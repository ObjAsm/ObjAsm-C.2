...
DrawTransparentBitmap proc hDC:HANDLE, hBitmap:HANDLE, xStart:DWORD, yStart:DWORD,
  ...
  local hTempDC:DWORD, dPrevColor:DWORD, PntSize:POINT
  local hObjDC :DWORD, hAndObjBmp:DWORD,  hPrevObjBmp:DWORD
  local hBackDC:DWORD, hAndBackBmp:DWORD, hPrevBackBmp:DWORD
  local hSaveDC:DWORD, hSaveBmp:DWORD,    hPrevSaveBmp:DWORD
  local hMemDC :DWORD, hAndMemBmp:DWORD,  hPrevMemBmp:DWORD
  ...
  invoke SetMapMode, hTempDC, $invoke(GetMapMode, hDC)
  ...
  .if (cTransparentColor == TBM_FIRSTPIXEL)
    mov cTransparentColor, $invoke(GetPixel, hTempDC, 0 , 0)
  .endif
  mov dPrevColor, $invoke(SetBkColor, hTempDC, cTransparentColor)
